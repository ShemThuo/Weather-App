...
async function updateForecastInfo(city) {
    ...
    const todayDate = new Date().ISOString().split('T')[0]
...
function updateForecastItems(weatherData) {
    ...
    const dateResult = dateTaken.toLocaleDateString('en-US', dateOtion)

    const forecastItem = `
        <div class="forecast-item">
            <h5 class="forecat-item-date regular-txt">${dateResult}</h5>
